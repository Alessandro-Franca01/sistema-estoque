        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 px-6 py-5 rounded-t-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                    ...
                    <p class="mt-1 text-indigo-100 text-sm sm:text-base">Ordem de Serviço: {{ $call->service_order ?? 'Sem Numero' }}</p>
                </div>
            ...
            <div class="bg-white shadow-md rounded-b-lg divide-y divide-gray-200">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">{{ $call->cep ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            @php
                                $arrDateHour = explode(' ', $call->output->output_date);
                            @endphp
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-500">Hora da Saída</p>
                            <p class="mt-1 text-sm text-gray-900">
                                    {{ $arrDateHour[1] }}
                        </div>
                        <div>
