                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="client_id" class="block text-gray-700 text-sm font-bold mb-2">
                                Responsável/Destino <span class="text-red-500">*</span>
                            </label>
                            <select name="client_id" id="client_id"
                                ...
                                <option value="">Selecione um destino ou responsável</option>
                                <option value="1">Destino/Responsável 01</option>
                                <option value="2">Destino/Responsável 02</option>
                                <option value="3">Destino/Responsável 03</option>
                                <option value="4">Destino/Responsável 04</option>
                                <option value="5">Destino/Responsável 05</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="conecta_number" id="document_number" value="{{ old('document_number') }}"
